...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-[var(--widget-surface)] group/calendar p-3 [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute bg-[var(--widget-surface-elevated)] inset-0 opacity-0",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-[var(--widget-text-secondary)] [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-[var(--widget-text-secondary)] rounded-md flex-1 font-normal text-[0.8rem] select-none",
        ...
        week_number: cn(
          "text-[0.8rem] select-none text-[var(--widget-text-secondary)]",
        ...
        range_start: cn(
          "rounded-l-md bg-[var(--widget-accent-soft)]",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn("rounded-r-md bg-[var(--widget-accent-soft)]", defaultClassNames.range_end),
        today: cn(
          "bg-[var(--widget-surface-tertiary)] text-[var(--widget-text-primary)] rounded-md data-[selected=true]:rounded-none",
          defaultClassNames.today
        ),
        outside: cn(
          "text-[var(--widget-text-tertiary)] aria-selected:text-[var(--widget-text-tertiary)]",
