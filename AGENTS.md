...
- Button: defaults to `style="secondary"`.
...
## shadcn documenation links - must search for updated usage syntax
...
- Typography: https://ui.shadcn.com/docs/components/typograph